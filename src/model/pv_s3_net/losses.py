import torch
from src.model.pv_s3_net import ramps
...
def semi_ce_loss(inputs, targets,
                 conf_mask=True, threshold=0.7,
                 threshold_neg=0.2, temperature_value=1):
