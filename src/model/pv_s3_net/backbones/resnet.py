...
from src.model.pv_s3_net.pyt_utils import load_model
...
def resnet50(pretrained_model=None, **kwargs):
    ...
    if pretrained_model is True:
        import os as _os
        _pretrained_dir = _os.path.join(_os.path.dirname(_os.path.abspath(__file__)), "..", "..", "..", "..", "weights", "pretrained")
        pretrained_model = _os.path.join(_pretrained_dir, 'resnet50.pth')
